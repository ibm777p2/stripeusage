...
# Aviso de Privacidad — Cambalachero

## 1. Responsable del tratamiento de datos
**BLB Digital Corp** (“Cambalachero”), con domicilio de contacto indicado vía correo electrónico en info@blbdigitalcorp.com, es responsable del tratamiento de los datos personales que recabamos de ti.

## 2. Datos que recabamos
Podemos recopilar:
- Datos de identificación (nombre, correo electrónico, teléfono, dirección).
- Datos fiscales y bancarios (solo para cuentas de vendedor).
- Información de transacciones y uso de la App.
- Datos técnicos (IP, tipo de dispositivo, sistema operativo).

## 3. Finalidades del tratamiento
Usamos tus datos para:
- Creación y gestión de tu cuenta.
- Procesar pagos y transferencias a vendedores mediante Stripe/Stripe Connect.
...
- Stripe, para procesamiento y dispersión de pagos.
- Autoridades competentes, cuando lo requiera la ley.
- Proveedores de servicios necesarios para la operación de la App.

## 5. Seguridad
Implementamos medidas técnicas, administrativas y físicas para proteger tus datos contra pérdida, uso indebido o acceso no autorizado.

## 6. Derechos ARCO
Puedes acceder, rectificar, cancelar u oponerte al tratamiento de tus datos enviando tu solicitud a **info@blbdigitalcorp.com**.

## 7. Cambios al Aviso de Privacidad
Podremos actualizar este Aviso; cualquier cambio se notificará en la App o vía correo electrónico.
...
- Unless otherwise indicated, Cambalachero **is not the seller** of the products and acts as a technological and payment intermediary.
- Cambalachero may withhold funds until delivery confirmation according to the App's operational flows.

## 3. Registration and Accounts
- You must provide truthful, complete, and up-to-date information.
- You are responsible for the confidentiality of your credentials and any activity carried out under your account.
- For seller accounts, valid tax, identity, and banking information may be required to receive payments.

## 4. Product Listing and Sales
- The seller is responsible for the description, price, images, condition, legality, and delivery of their products.
- The posting or sale of illegal, dangerous, counterfeit, or infringing products is prohibited.
- Cambalachero may unpublish or remove content that violates these Terms or the law.

## 5. Prices, Shipping, and Shipping Calculation
- Shipping costs are primarily calculated based on distance (per-kilometer rate) and may be subject to a **minimum shipping fee** according to current policies.
- The buyer sees the shipping cost **including taxes** and the applicable **service fee** before confirming the purchase.
- The seller is responsible for shipping the product on time and in accordance with the checkout details.

## 6. Fees and Charges
- Cambalachero applies a **service fee** that will be displayed before the purchase is confirmed.
- **Payment processing fees (Stripe)** are deducted from the amount deposited to the seller, according to Stripe’s current rates and/or the App’s commercial terms.
- Any applicable taxes (e.g., VAT) on fees and/or services will be calculated and shown in the breakdown.

## 7. Payments, Holds, and Seller Payouts
- Buyer payments are processed via **Stripe**, and seller payouts are made through **Stripe Connect**.
- Funds are usually released **3–4 business days after delivery** (excluding weekends and holidays), unless held for fraud prevention, disputes, or verification.
- Timeframes may vary based on Stripe policies, the receiving bank, or additional security reviews.

## 8. Taxes and Invoicing
- Each seller is responsible for **issuing tax receipts** to their buyers, where applicable, and **complying with tax obligations**.
- Cambalachero may issue invoices for its **own services or fees**, where applicable.
- Tax treatment (e.g., VAT) is handled according to applicable laws and may be reflected in the purchase breakdown.

## 9. Refunds, Cancellations, and Disputes
- Refund and cancellation policies may vary by product and seller; buyers should review the information provided in each listing.
- Disputes between buyers and sellers should be resolved in good faith between the parties. Cambalachero may, at its discretion, assist as a mediator **without legal obligation**.
- In cases of chargebacks or suspicious transactions, holds and/or additional reviews may apply.

## 10. User Conduct
By using the App, you agree to:
- Not engage in fraudulent activities or use the App for illegal purposes.
- Not infringe on copyrights, trademarks, privacy, or any other third-party rights.
- Not interfere with the App’s operation or attempt to access unauthorized areas.
- Respect other users’ experience and comply with these Terms.

## 11. Intellectual Property
- The App, its software, design, trademarks, and proprietary content are owned by their respective holders and are protected by intellectual property laws.
- No license is granted except for the limited permission to use the App in accordance with these Terms.

## 12. Service Availability and Modifications
- Cambalachero may modify, suspend, or discontinue App features, in whole or in part, at any time, with or without notice.
- These Terms may be updated; changes will take effect when published in the App or communicated to the user.

## 13. Privacy and Personal Data
- Data processing is governed by the applicable **Privacy Policy**, available in the App or on the relevant website.
- The use of Stripe and Stripe Connect involves the processing of data according to Stripe’s **privacy policies**.

## 14. Limitation of Liability
To the extent permitted by law:
- Cambalachero does not guarantee the quality, safety, legality, or suitability of products posted by sellers.
- Cambalachero is not responsible for indirect losses, lost profits, consequential damages, or failures attributable to third parties (including Stripe).
- The App is provided “as is” and “as available.”

## 15. Indemnification
You agree to indemnify and hold harmless Cambalachero, its affiliates, officers, and employees against any claims arising from: (i) your use of the App; (ii) your breach of these Terms; or (iii) infringement of third-party rights.

## 16. Termination
- Cambalachero may suspend or terminate your access for breach of these Terms or for security reasons.
- You may stop using the App at any time; however, outstanding obligations (e.g., deliveries or payments) will remain in effect.

## 17. Governing Law and Jurisdiction
- Unless otherwise required by mandatory law, these Terms will be governed by the laws applicable in Cambalachero’s place of incorporation/operation.
- Any dispute will be submitted to the competent courts of that jurisdiction.

## 18. Contact
For questions or comments about these Terms:
- **Email:** info@blbdigitalcorp.com

---

# Privacy Policy — Cambalachero

## 1. Data Controller
**BLB Digital Corp** (“Cambalachero”), with contact via email at info@blbdigitalcorp.com, is responsible for the processing of the personal data we collect from you.

## 2. Data We Collect
We may collect:
- Identification data (name, email, phone number, address).
- Tax and banking details (only for seller accounts).
- Transaction and App usage information.
- Technical data (IP address, device type, operating system).

## 3. Purpose of Data Processing
We use your data to:
- Create and manage your account.
- Process payments and transfers to sellers via Stripe/Stripe Connect.
...
- Stripe, for payment processing and fund disbursement.
- Competent authorities when required by law.
- Service providers essential to App operations.

## 5. Security
We implement technical, administrative, and physical measures to protect your data from loss, misuse, or unauthorized access.

## 6. ARCO Rights (Access, Rectification, Cancellation, Opposition)
You may access, rectify, cancel, or object to the processing of your data by sending your request to **info@blbdigitalcorp.com**.

## 7. Changes to the Privacy Policy
We may update this Policy; any changes will be notified within the App or via email.
